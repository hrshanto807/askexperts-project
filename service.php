...
<section class="aep-home-hero-area" style="background: url(<?php $services_hero_bg = aepexpert_get_option('service-hero-bg');
                        ...
                        <div class="single-price-list">
                            ...
                            <div class="aep-single-price-bottom mt-5">
                                ...
                                if (!empty($support_price)) : foreach ($support_price as $support) : ?>
                                        <li><?php if (!empty($support)) {
                                                echo esc_html($support['price-support']);
                                            } ?></li>
                                <?php endforeach;
                                endif; ?>
                            </div>
